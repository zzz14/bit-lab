...
unsigned float_neg(unsigned uf) {
  ...
  int frac = (uf&0x007fffff)^0x00000000;
  if(exp || !frac) return (uf & 0x7fffffff) | ~(0x7fffffff | uf);
  else return uf;
}
/* 
...
unsigned float_i2f(int x) {
  ...
  if(!x) return 0x00000000;
    ...
    r = r | ((x >> 7) & 0x00ffffff);
    if((r & 0x00000001)) r = r+0x00000001;
    return s | ((r>>1)&0x7fffffff);
}
/* 
...
unsigned float_twice(unsigned uf) {
  ...
  if(!(exp^0x00000000)) return s | (uf << 1);
